...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { family: @family.family, idFamily: @family.idFamily } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { family: @family.family, idFamily: @family.idFamily } }
